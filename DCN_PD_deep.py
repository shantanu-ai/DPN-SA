...
class DCN_PD_Deep_Experiments_original_data:
    ...
    def __test_DCN(self, iter_id, np_covariates_X_test, np_covariates_Y_test, dL, sparse_classifier,
        ...
        propensity_score_save_path_stacked_all = "./MSE/SAE_stacked_all_Prop_score_{0}.csv"
        propensity_score_save_path_stacked_cur = "./MSE/SAE_stacked_cur_Prop_score_{0}.csv"

        ITE_save_path_e2e = "./MSE/ITE/ITE_SAE_E2E_iter_{0}.csv"
        ITE_save_path_stacked_all = "./MSE/ITE/ITE_SAE_stacked_all_iter_{0}.csv"
        ITE_save_path_stacked_cur = "./MSE/ITE/ITE_SAE_stacked_cur_Prop_iter_{0}.csv"

...
class Sparse_Propensity_score:
    ...
    def train(self, train_parameters, device, phase):
        ...
        val_set = train_parameters["val_set"]
        ...
        data_loader_val = torch.utils.data.DataLoader(val_set, batch_size=batch_size,
    ...
    def __end_to_end_train_SAE(self, phase, device, epochs, data_loader_train,
        ...
        sparse_classifier = self.__train_classifier(train_set, val_set, device, phase, sparse_classifier)
        return sparse_classifier
    ...
    def __train_classifier(self, train_set, val_set, device, phase, sparse_classifier):
        print(device)
        ...
        data_loader_val = torch.utils.data.DataLoader(val_set, batch_size=1,
                                                      shuffle=True, num_workers=4)
        phases = ['train', 'val']
        min_accuracy = 0
